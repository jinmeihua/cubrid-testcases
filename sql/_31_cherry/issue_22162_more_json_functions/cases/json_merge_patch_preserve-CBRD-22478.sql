--https://database.guide/json_merge_patch-perform-an-rfc-7396-compliant-merge-of-json-documents-in-mysql/
--https://database.guide/json_merge_preserve-merge-multiple-json-documents-in-mysql/
